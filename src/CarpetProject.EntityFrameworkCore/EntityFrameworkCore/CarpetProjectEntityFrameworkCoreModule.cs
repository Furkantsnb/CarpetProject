...
[DependsOn(typeof(CmsKitEntityFrameworkCoreModule))]
    public class CarpetProjectEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<CarpetProjectDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also CarpetProjectMigrationsDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
